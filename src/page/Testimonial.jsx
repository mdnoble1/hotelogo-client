    ...
    return (
      <>
        <div className="lg:my-16">
          <h1 className="text-3xl lg:text-5xl font-bold text-[#D31027] px-4 leading-10  mt-6 text-center">
          ...
          <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-10 lg:py-20 gap-6">
            <div>
              <div
                className="group w-full bg-white relative flex flex-col items-center hover:bg-[#D31027] cursor-pointer shadow-md md:p-12 p-6"
                data-aos="zoom-out"
              ...
              >
                <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                  ...
                  I have been using HoteloGo for all my hotel bookings for the past year, and I could not be happier with the service. The website is user-friendly, and finding the perfect hotel at the best price is a breeze. I appreciate the detailed information provided about each hotel, including photos, reviews, and amenities. The booking process is seamless, and I have never encountered any issues with my reservations. Plus, their customer support is top-notch, always ready to assist if needed. I highly recommend HoteloGo to anyone in need of a reliable and convenient hotel booking platform.
                  </p>
                </div>
              ...
              <div className="flex flex-col items-center justify-center mt-10 rounded-full">
                <img
                  ...
                  className="w-12 h-12"
                />
                <p className="text-base font-semibold leading-4 my-2 text-[#D31027]">
                  John Deo
                </p>
              </div>
            </div>
