const Room = ({ service }) => {
  const { roomType, roomImage, description, pricePerNight } = service;
  return (
    <div className="w-11/12 lg:w-[450px] rounded border border-gray-400 mx-auto">
      ...
      <p className="font-medium text-lg text-gray-600 my-4 mx-6">{description}</p>
      <div className="flex justify-between items-center px-6 pb-10">
        ...
        <p className="font-semibold text-lg text-[#D31027]">{pricePerNight} / Night</p>
      </div>
    </div>
  );
};
